...
create_clock -add -name horloge -period 10.00 -waveform {0 5} [get_ports clk]
 
## Switches
##Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
set_property PACKAGE_PIN U9 [get_ports raz]					
set_property IOSTANDARD LVCMOS33 [get_ports raz]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {choice}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {choice}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {choice_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {choice_2}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {choice_3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {choice_3}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {choice_4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {choice_4}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {choice_5}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {choice_5}]
...
set_property PACKAGE_PIN R3 [get_ports {hard}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hard}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {medium}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {medium}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {easy}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {easy}]
...
set_property PACKAGE_PIN L3 [get_ports Sept_segments[0]]					
set_property IOSTANDARD LVCMOS33 [get_ports Sept_segments[0]]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports Sept_segments[1]]					
set_property IOSTANDARD LVCMOS33 [get_ports Sept_segments[1]]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports Sept_segments[2]]					
...
set_property PACKAGE_PIN K3 [get_ports Sept_segments[4]]					
set_property IOSTANDARD LVCMOS33 [get_ports Sept_segments[4]]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports Sept_segments[5]]					
set_property IOSTANDARD LVCMOS33 [get_ports Sept_segments[5]]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports Sept_segments[6]]					
...
#set_property PACKAGE_PIN E16 [get_ports Bouton_CENTER]						
#set_property IOSTANDARD LVCMOS33 [get_ports Bouton_CENTER]
...
set_property PACKAGE_PIN A3 [get_ports {VGA_color[8]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[8]}]
##Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports {VGA_color[9]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[9]}]
##Bank = 35, Pin name = IO_L1N_T0_AD4N_35,					Sch name = VGA_R2
set_property PACKAGE_PIN C5 [get_ports {VGA_color[10]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[10]}]
##Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports {VGA_color[11]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[11]}]
##Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports {VGA_color[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[0]}]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports {VGA_color[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[1]}]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports {VGA_color[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[2]}]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports {VGA_color[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[3]}]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports {VGA_color[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[4]}]
##Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports {VGA_color[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[5]}]
##Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports {VGA_color[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[6]}]
##Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports {VGA_color[7]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_color[7]}]
